...
cerver::math::Vector3f::Vector3f(Vector4f vector4f) {
    this->m_x = vector4f.x();
    this->m_y = vector4f.y();
    this->m_z = vector4f.z();
}
...
void cerver::math::Vector3f::load(const Vector3f &vector3f) {
    this->m_x = vector3f.x();
    this->m_y = vector3f.y();
    this->m_z = vector3f.z();
}
...
void cerver::math::Vector3f::add(const Vector3f &vector3f) {
    this->m_x += vector3f.x();
    this->m_y += vector3f.y();
    this->m_z += vector3f.z();
}

void cerver::math::Vector3f::sub(Vector3f vector3f) {
    this->m_x -= vector3f.x();
    this->m_y -= vector3f.y();
    this->m_z -= vector3f.z();
}

double cerver::math::Vector3f::dot(Vector3f vector3f) {
    return this->m_x * vector3f.x() + this->m_y * vector3f.y() + this->m_z * vector3f.z();
}

void cerver::math::Vector3f::cross(Vector3f vector3f) {
    double f = this->m_x;
    double f2 = this->m_y;
    double f3 = this->m_z;
...
void cerver::math::Vector3f::transform(Matrix3f matrix3f) {
    double f = this->m_x;
    double f2 = this->m_y;
    double f3 = this->m_z;
...
void cerver::math::Vector3f::transform(const Quaternion &quaternion) {
...
void cerver::math::Vector3f::lerp(const Vector3f& vector3f, double f) {
    double f2 = 1.0 - f;
...
cerver::math::Quaternion cerver::math::Vector3f::rotation(double f) {
    return {static_cast<std::shared_ptr<Vector3f>>(this), f, false};
}

cerver::math::Quaternion cerver::math::Vector3f::rotationDegrees(double f) {
    return {static_cast<std::shared_ptr<Vector3f>>(this), f, true};
}
